...
#define VECT_TAB_OFFSET  0x00 /*!< Vector Table base offset field. 
  ...
  /* IMPORTANT NOTE
     ==============
       ...
       must be respected:
         ¨C 25 MHz external crystal connected to OSCIN/OSCOUT pins
         ¨C RCC_PLLCFGR PLL factors configured as follows:
           PLLMx = 4, PLLNx = 64, PLLP = 4.
           This leads to a system clock of 100 MHz.
         ¨C Then set the MCO prescaler to 2 in the RCC_CFGR register to configure
