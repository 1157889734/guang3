...
#include "sample_comm.h"
	...
	*****************************************************************************/
	HI_S32 SAMPLE_COMM_VPSS_Start(VPSS_GRP VpssGrp, SIZE_S *pstSize, HI_S32 s32ChnCnt,VPSS_GRP_ATTR_S *pstVpssGrpAttr)
	{
		VPSS_CHN VpssChn;
	...
	*****************************************************************************/
	HI_S32 SAMPLE_COMM_VPSS_Stop(VPSS_GRP VpssGrp, HI_S32 s32ChnCnt)
	{
		HI_S32 i, j;
