...
HI_S32 HI_MPI_VI_SetVbiAttr(VI_CHN ViChn, HI_S32 s32VbiId, VI_VBI_ATTR_S *pstVbiAttr);
HI_S32 HI_MPI_VI_GetVbiAttr( VI_CHN ViChn, HI_S32 s32VbiId, VI_VBI_ATTR_S *pstVbiAttr);
HI_S32 HI_MPI_VI_EnableVbi(VI_CHN ViChn, HI_S32 s32VbiId);
HI_S32 HI_MPI_VI_DisableVbi(VI_CHN ViChn, HI_S32 s32VbiId);
