...
#define IMAGE_DARK_IMAGE_WIDTH              20
...
const u8 show_dark_image[16][IMAGE_DARK_IMAGE_WIDTH]=
{
...
void LoadRowData(void)
{
    ...
    {
        for (i = 0; i < IMAGE_ERROR_IMAGE_WIDTH; i++) SpiDmaBuf[i] = show_dark_image[gDispStat.row_index][i];
    }
