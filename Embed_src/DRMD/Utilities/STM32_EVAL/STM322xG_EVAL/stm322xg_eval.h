 ...
 */ 
#define EVAL_COM4                        USART3
#define EVAL_COM4_CLK                    RCC_APB1Periph_USART3
#define EVAL_COM4_TX_PIN                 GPIO_Pin_8
#define EVAL_COM4_TX_GPIO_PORT           GPIOD
#define EVAL_COM4_TX_GPIO_CLK            RCC_AHB1Periph_GPIOD
#define EVAL_COM4_TX_SOURCE              GPIO_PinSource8
#define EVAL_COM4_TX_AF                  GPIO_AF_USART3
#define EVAL_COM4_RX_PIN                 GPIO_Pin_9
#define EVAL_COM4_RX_GPIO_PORT           GPIOD
#define EVAL_COM4_RX_GPIO_CLK            RCC_AHB1Periph_GPIOD
#define EVAL_COM4_RX_SOURCE              GPIO_PinSource9
#define EVAL_COM4_RX_AF                  GPIO_AF_USART3
#define EVAL_COM4_IRQn                   USART3_IRQn
