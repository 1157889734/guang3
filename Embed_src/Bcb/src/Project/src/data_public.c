...
tFrameHeader gBoxData = {0}; // 发送给广播控制盒的数据
tPiscHeader gPiscData={0};   // 记录中央控制器的过程数据
tHmiHeader gHmiData={0};  //发送给hmi的数据
tBcuHeader gBcuData={0};  // 发送给中央控制器的数据
